...
if("TRUE" STREQUAL "TRUE")
  set(quadrotor_msgs_SOURCE_PREFIX /home/qsl/hw_9/src/read_only/Utils/quadrotor_msgs)
  set(quadrotor_msgs_DEVEL_PREFIX /home/qsl/hw_9/devel)
  ...
  set(quadrotor_msgs_INSTALL_PREFIX /home/qsl/hw_9/install)
...
if(NOT "/home/qsl/hw_9/devel/include " STREQUAL " ")
  set(quadrotor_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/qsl/hw_9/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'quadrotor_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/qsl/hw_9/src/read_only/Utils/quadrotor_msgs/${idir}'.  ${_report}")
    endif()
